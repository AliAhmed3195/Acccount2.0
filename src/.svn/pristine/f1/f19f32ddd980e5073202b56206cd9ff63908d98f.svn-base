(function ()
{
    ...
    /** @ngInject */
    function ToolbarController($rootScope, $q, $state, $timeout, $mdSidenav, $translate, $mdToast, msNavigationService,HelperService,$window)
    {
        var vm = this;
        ...
        vm.user_name=HelperService.getUserName();
        vm.topMenuList=HelperService.getTopMenus();
        vm.TopMenu=TopMenu;
