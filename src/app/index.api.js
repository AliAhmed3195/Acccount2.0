(function ()
{
    ...
    /** @ngInject */
    function apiService($resource,Clique)
    {
        /**
        ...
        //api.baseUrl = 'http://localhost/slim/paysync/public/';
        //api.version = "v1/";
        /*api.account={
            login:$resource(api.baseUrl + api.version+'account/login'),
            forgot:$resource(api.baseUrl + api.version+'account/forget'),
            signup:$resource(api.baseUrl + api.version+'account/signup')
